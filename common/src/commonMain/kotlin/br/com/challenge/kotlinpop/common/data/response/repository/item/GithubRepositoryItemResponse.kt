package br.com.challenge.kotlinpop.common.data.response.repository.item
...
@Serializable
data class GithubRepositoryItemResponse(
    ...
    @SerialName("license")
    val githubRepositoryLicenseDomain: GithubRepositoryLicenseResponse? = null,
    ...
    @SerialName("owner")
    val githubRepositoryOwnerDomain: GithubRepositoryOwnerResponse? = null,
    @SerialName("private")
