package br.com.challenge.kotlinpop.common.data.response.pr.repo
...
@Serializable
data class GithubPRResultRepoResponse(
    ...
    @SerialName("license")
    val githubPRResultLicenseResponse: GithubPRResultLicenseResponse? = null,
    ...
    @SerialName("owner")
    val githubPRResultOwnerResponse: GithubPRResultOwnerResponse? = null,
    @SerialName("private")
